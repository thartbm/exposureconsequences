...
Alternatively, if you want to check the results, you can run this chunk to delete the pre-calculated results, which will force the code to re-calculate it. However, by default, the code here will only use 5000 iterations for bootstrapping, which will ensure that the confidence intervals are less precise than the ones we pre-calculated.
