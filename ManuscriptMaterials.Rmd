...
getPeakLocConfidenceInterval(group='classic',CIs=c(.95), movementtype='both', LRpart='all')
getPeakLocConfidenceInterval(group='exposure',CIs=c(.95), movementtype='both', LRpart='all')
```

These results are strange: the median peak for the exposure localization is around 42 degrees. If we look at the plot, it is much higher though, somewhere between 55 and 65 probably. This doesn't change much if I only look at the passive or at the active localization data. The peak for classic makes sense though.
