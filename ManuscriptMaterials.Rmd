...
In the exposure group there is no effect of movement type, but we see one here. This could be because the effect of movement type is much larger in the classic group. This would predict an interaction between group and movement type, but this is not even a trend (p=.133). Hence we tested for an effect of movement type in the classic group:
